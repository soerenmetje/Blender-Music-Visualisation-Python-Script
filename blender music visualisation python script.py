...
# Frequency range of whole visualizer
spectrum_Start = 10  # in Hz
spectrum_End = 21000  # in Hz

# Path to music file
path = os.path.abspath("C:\\Users\myusername\Desktop\music.mp3")
...
print("STARTED (Cubes_Spectrum=" + str(collums) + ", Cubes_Vertical=" + str(rows) + ", Cube_Height=" + str(
    maxheight) + ", Cube_Count=" + str(collums * rows) + ")")
...
for i in range(0, collums):
    ...
    print(str(round(((i + 1) / collums) * 100, 1)) + "%   done in " + (
